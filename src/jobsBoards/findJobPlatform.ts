...
async function searchForJobBoardType(browser: Browser, url: string): Promise<{ confirmedUrl: string, boardType: string }> {
...
async function findJobBoardFromUrl(browser: Browser, url: string): Promise<Job[]> {
  let confirmedUrl = url;
