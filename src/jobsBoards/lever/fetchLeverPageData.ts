...
async function addDescription(jobs: Job[], browser: Browser): Promise<Job[]> {
...
async function fetchLeverPageData(browser: Browser, companyName: string): Promise<Job[] | null> {
