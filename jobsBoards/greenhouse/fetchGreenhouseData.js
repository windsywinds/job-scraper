...
function fetchGreenhouseFromAPI(companyName) {
        ...
        try {
            ...
            for (let index = 0; index < data.length; index++) {
                ...
                try {
                    ...
                    const jobResponse = yield fetch(`https://boards-api.greenhouse.io/v1/boards/${companyName}/jobs/${String(job.id)}`);
                    if (jobResponse.ok) {
...
exports.default = fetchGreenhouseFromAPI;
